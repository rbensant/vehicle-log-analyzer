...
## Sample Output
Note that the real output is color-coded via colorama.
...
Log file:
C:\VSCode\vehicle-log-analyzer\samples\sample_log_1.log
...
[*PRI. CHANGE] [PDT] 14.04.2026, 08:15:23.100  |  Primary conn. state: UNKNOWN  ---  Line:15
[*PRI. CHANGE] [PDT] 14.04.2026, 08:15:23.500  |  Primary conn. state: DISCONNECTED  ---  Line:16
[*SEC. CHANGE] [PDT] 14.04.2026, 08:15:23.600  |  Secondary conn. state: UNKNOWN  ---  Line:17
...
[***RESET!***] [PDT] 14.04.2026, 10:45:00.200  |  System RESET detected  ---  Line:43
...
1x 'Device not registered to network' log msgs
2x 'Primary connection disconnected' log msgs
2x 'Secondary connection disconnected' log msgs
1x 'Primary connection unknown' log msgs
1x 'Secondary connection unknown' log msgs
1x 'eCall triggered' log msgs
1x 'eCall callback' log msgs
1x 'Emergency data delivered' log msgs
1x 'Modem crash' log msgs
1x 'System reset' log msgs
62 log lines in log #1 analyzed in 0.0s


 ========================= NEW LOG ('Log #2')============================

Log file:
C:\VSCode\vehicle-log-analyzer\samples\sample_log_2.log
...
[***RESET!***] [PDT] 15.04.2026, 11:22:05.400  |  System RESET triggered  ---  Line:30
...
1x 'Device not registered to network' log msgs
3x 'Primary connection disconnected' log msgs
1x 'Secondary connection disconnected' log msgs
1x 'eCall triggered' log msgs
1x 'Emergency data delivered' log msgs
1x 'System reset' log msgs
59 log lines in log #2 analyzed in 0.0s
